export const initialNavLinks = [
  ...
  {
    id: 2,
    title: 'A Motivational To-Do List',
    url: 'https://tetiana-zhuchenko.github.io/todo-list-with-motivation/',
    codeUrl:
  ...
  {
    id: 3,
    title: 'Adaptive Website for Restaurant',
    url: 'Adaptive Website for Restaurant',
